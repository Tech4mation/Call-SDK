...
class ControlsViewModel() : ViewModel() {
    ...
    // CA
    val callSpeakerState: MutableLiveData<Boolean> by lazy {
        MutableLiveData<Boolean>()
    }

    val muteSpeakerState: MutableLiveData<Boolean> by lazy {
        MutableLiveData<Boolean>()
    }

    val holdSpeakerState: MutableLiveData<Boolean> by lazy {
        MutableLiveData<Boolean>()
    }

    val listenForHangup: MutableLiveData<Boolean> by lazy {
        MutableLiveData<Boolean>()
    }
    // END
    ...
    fun toggleSpeaker() {
        if (AudioRouteUtils.isSpeakerAudioRouteCurrentlyUsed()) {
            ...
            // CA
            callSpeakerState.value = false
            // END
        } else {
            forceSpeakerAudioRoute()

            // CA i.e Custom Addition
            callSpeakerState.value = true
            // END
        }
    }
